// noinspection JSDuplicatedDeclaration,JSJQueryEfficiency,JSVoidFunctionReturnValueUsed,JSUnresolvedFunction,DuplicatedCode,SpellCheckingInspection
...
(function ($) {
    $.fn.tipTip = function (options) {
        ...
        // Setup tip elements and render them to the DOM
        ...
        return this.each(function () {
            ...
            if (org_title !== "") {
                ...
                function active_tiptip() {
                    ...
                    let top = parseInt(org_elem.offset()['top']);
                    let left = parseInt(org_elem.offset()['left']);
                    let org_width = parseInt(org_elem.outerWidth());
                    const org_height = parseInt(org_elem.outerHeight());
                    let tip_w = tiptip_holder.outerWidth();
                    let tip_h = tiptip_holder.outerHeight();
                    let w_compare = Math.round((org_width - tip_w) / 2);
                    let h_compare = Math.round((org_height - tip_h) / 2);
