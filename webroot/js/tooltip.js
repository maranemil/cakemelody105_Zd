...
let qTipTag = "a"; //Which tag do you want to qTip-ize? Keep it lowercase!//
let qTipX = 0; //This is qTip's X offset//
let qTipY = -100; //This is qTip's Y offset//
...
tooltip.init = function () {
    let tipContainerID = "qTip";
    let tipNameSpaceURI = "http://www.w3.org/1999/xhtml";
    if (!tipContainerID) {
    }
    ...
    let a, sTitle;
    let anchors = document.getElementsByTagName(qTipTag);
