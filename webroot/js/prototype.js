// noinspection JSUnusedAssignment,JSPotentiallyInvalidConstructorUsage,SpellCheckingInspection,CommaExpressionJS,WithStatementJS,JSDuplicatedDeclaration,FallThroughInSwitchStatementJS
...
Object.extend(Object, {
    ...
    toJSON: function (object) {
        ...
        for (const property in object) {
            const value = Object.toJSON(object[property]);
...
if (Prototype.Browser.Opera) {
    Array.prototype.concat = function () {
        ...
        let length;
        const array = [];
        for (; i < length; i++) array.push(this[i]);
        i = 0;
...
Ajax.Updater = Class.create(Ajax.Request, {
    ...
    updateContent: function (responseText) {
        const receiver = this.container[this.success() ? 'success' : 'failure'],
...
Element.Methods = {
    ...
    previous: function (element, expression, index) {
        ...
        const previousSiblings = element.previousSiblings();
    ...
    next: function (element, expression, index) {
        ...
        const nextSiblings = element.nextSiblings();
...
// removes whitespace-only text node children
    ...
    descendantOf: function (element, ancestor) {
        ...
        if (element.sourceIndex && !Prototype.Browser.Opera) {
            let e = element.sourceIndex, a = ancestor.sourceIndex,
...
if (Prototype.Browser.Opera) {
    ...
    Element.Methods.setOpacity = function (element, value) {
        ...
        let filter = element.getStyle('filter'), style = element.style;
        if (value === 1 || value === '') {
...
Object.extend(Event, (function () {
    ...
    function findWrapper(id, eventName, handler) {
        let c = getWrappersForEventName(id, eventName);
...
if (!document.getElementsByClassName) document.getElementsByClassName = function (instanceMethods) {
    ...
    instanceMethods.getElementsByClassName = Prototype.BrowserFeatures.XPath ?
        function (element, className) {
            ...
            className = className.toString().strip();
            const elements = [], classNames = (/\s/.test(className) ? $w(className) : null);
